...
public class OrdenarPrecosMergeSortMelhorCaso { 
    private static final String caminhoArquivoParaSerLido = "./Dados/games_price_MergeSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_price_MergeSort_melhorCaso.csv";
