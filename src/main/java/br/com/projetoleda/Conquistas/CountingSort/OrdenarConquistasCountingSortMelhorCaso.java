...
public class OrdenarConquistasCountingSortMelhorCaso {
    private static final String caminhoArquivoParaSerLido = "./Dados/games_achievements_CountingSort_medioCaso.csv";;
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_achievements_CountingSort_melhorCaso.csv";
