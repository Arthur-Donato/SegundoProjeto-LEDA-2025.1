...
public class OrdenarConquistasQuickSortMediana3MelhorCaso {
     private static final String caminhoArquivoParaSerLido = "./Dados/games_achievements_QuickSortMediana3_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_achievements_QuickSortMediana3_melhorCaso.csv";
