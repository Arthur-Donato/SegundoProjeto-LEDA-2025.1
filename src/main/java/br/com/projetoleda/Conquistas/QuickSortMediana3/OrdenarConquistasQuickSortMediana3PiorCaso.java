...
public class OrdenarConquistasQuickSortMediana3PiorCaso {
     private static final String caminhoArquivoParaSerLido = "./Dados/games_achievements_Invertido.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_achievements_QuickSortMediana3_piorCaso.csv";
