...
public class OrdenarConquistasHeapSortMelhorCaso {
    private static final String caminhoArquivoParaSerLido = "./Dados/games_achievements_HeapSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_achievements_HeapSort_melhorCaso.csv";
