...
public class OrdenarConquistasMelhorCaso { 
    private static final String caminhoArquivoParaSerLido = "./Dados/games_achievements_MergeSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_achievements_MergeSort_melhorCaso.csv";
