...
public class OrdenarDatasHeapSortMelhorCaso {
    private static final String caminhoArquivoParaSerLido = "./Dados/games_release_date_HeapSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_release_date_HeapSort_melhorCaso.csv";
