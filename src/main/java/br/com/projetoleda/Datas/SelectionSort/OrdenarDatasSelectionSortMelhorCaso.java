...
public class OrdenarDatasSelectionSortMelhorCaso {
    private static final String caminhoArquivoParaSerLido = "./Dados/games_release_date_SelectionSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_release_date_SelectionSort_melhorCaso.csv";
