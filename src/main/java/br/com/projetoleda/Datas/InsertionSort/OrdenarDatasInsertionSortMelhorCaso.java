...
public class OrdenarDatasInsertionSortMelhorCaso {
    private static final String caminhoArquivoParaSerLido = "./Dados/games_release_date_InsertionSort_medioCaso.csv";
    private static final String CAMINHO_ARQUIVO_GERADO = "./Dados/games_release_date_InsertionSort_melhorCaso.csv";
